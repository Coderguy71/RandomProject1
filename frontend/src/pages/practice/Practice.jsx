...
import { topicsAPI, problemsAPI, attemptsAPI } from '../../services/apiServices';
import { Card, Button, Badge, Spinner, Modal, ProgressBar } from '../../components/ui';
...
const Practice = () => {
  ...
  const fetchProblems = async (subtopic) => {
    try {
      setLoadingProblems(true);
      const response = await problemsAPI.getProblems({ subtopic_id: subtopic.id });
      ...
      <div className="animate-fade-in">
        <div className="mb-8">
          ...
          <p className="text-dark-400">
            Select a subtopic to start practicing
          </p>
        </div>
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-dark-400 mb-6">
          There are no problems available for {selectedSubtopic.name} yet.
        </p>
        <Button onClick={handleBackToSubtopics} variant="primary">
          Back to Subtopics
        </Button>
      </div>
    );
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button variant="ghost" onClick={handleBackToSubtopics}>
              Exit Session
            </Button>
          </div>
        </div>
