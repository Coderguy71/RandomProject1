  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card variant="glass" className="hover:shadow-glow transition-all duration-300">
          <div className="p-6">
            ...
            <p className="text-sm font-medium text-dark-400 mb-2">Problems Solved</p>
            <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-premium">
              {totalProblemsAttempted}
            </p>
            <p className="text-xs text-dark-500 mt-2">Lifetime attempts: {analytics?.summary?.totalAttempts || 0}</p>
          </div>
        </Card>
        ...
        <Card variant="glass" className="hover:shadow-glow transition-all duration-300">
          <div className="p-6">
            ...
            <p className="text-sm font-medium text-dark-400 mb-2">Current Streak</p>
            <p className="text-3xl font-bold text-orange-400">{currentStreak}</p>
            <p className="text-xs text-dark-500 mt-2">Best: {longestStreak} days</p>
          </div>
        </Card>
        ...
        <Card variant="glass" className="hover:shadow-glow transition-all duration-300">
          <div className="p-6">
            ...
            <p className="text-sm font-medium text-dark-400 mb-2">Overall Accuracy</p>
        ...
        <Card variant="glass" className="hover:shadow-glow transition-all duration-300">
          <div className="p-6">
            ...
            <p className="text-sm font-medium text-dark-400 mb-2">Village Health</p>
            <p className="text-3xl font-bold text-purple-400">{villageHealth}%</p>
            <ProgressBar 
              value={villageHealth} 
              max={100}
              className="mt-3"
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card variant="default" className="border border-card-border/50">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-premium">
                  Today's Activity
                </h2>
          ...
          <Card variant="default" className="border border-card-border/50">
            <div className="p-6">
              ...
              <div className="relative h-48 bg-gradient-to-b from-blue-900/20 to-dark-800 rounded-lg overflow-hidden mb-4 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-5xl mb-2">🏘️</div>
                  <p className="text-dark-400">Level {villageLevel} Village</p>
                  <p className="text-xs text-dark-500 mt-1">Health: {villageHealth}% 💚</p>
                </div>
              </div>
              ...
              {nextRecommendation ? (
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                    <p className="text-xs text-white/70 mb-1">Recommended Accuracy</p>
              ...
              {recentActivity && recentActivity.length > 0 ? (
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  {recentActivity.slice(0, 5).map((activity, idx) => (
                    <div 
                      key={idx}
                      className="flex items-start space-x-3 p-3 bg-dark-800/50 rounded-lg hover:bg-dark-800 transition-colors"
                    >
      ...
      {analytics?.topics?.status && (
        <Card variant="default" className="border border-card-border/50">
          <div className="p-6">
            <h2 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-premium mb-6">
              Your Progress by Topic
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="p-4 bg-gradient-to-br from-green-900/20 to-green-900/5 rounded-lg border border-green-800/30">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-medium text-green-400">Mastered</p>
                  <span className="text-2xl font-bold text-green-400">{analytics.topics.status.counts.mastered}</span>
                </div>
                <p className="text-xs text-green-600">Topics you've mastered</p>
              </div>
              <div className="p-4 bg-gradient-to-br from-yellow-900/20 to-yellow-900/5 rounded-lg border border-yellow-800/30">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-medium text-yellow-400">In Progress</p>
                  <span className="text-2xl font-bold text-yellow-400">{analytics.topics.status.counts.inProgress}</span>
                </div>
                <p className="text-xs text-yellow-600">Topics you're working on</p>
              </div>
              <div className="p-4 bg-gradient-to-br from-red-900/20 to-red-900/5 rounded-lg border border-red-800/30">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-medium text-red-400">Needs Work</p>
                  <span className="text-2xl font-bold text-red-400">{analytics.topics.status.counts.weak}</span>
                </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-800/30">
              <p className="text-sm font-medium text-blue-400 mb-1">Consistency is Key</p>
            ...
            <div className="p-4 bg-purple-900/20 rounded-lg border border-purple-800/30">
              <p className="text-sm font-medium text-purple-400 mb-1">Review Weak Topics</p>
            ...
            <div className="p-4 bg-orange-900/20 rounded-lg border border-orange-800/30">
              <p className="text-sm font-medium text-orange-400 mb-1">Celebrate Wins</p>
